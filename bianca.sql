...
/*1*/
insert into Livros (titulo, autor, ano_publicacao, disponivel, categoria, isbn, editora, quantidade_paginas, idioma) VALUES 
("As Crônicas de Nárnia", "C.S Lewis", 1950, "Fantasia", "978-0064471190", "Editora Harper Collins", 768, "Francês");

/*2*/ 
update Livros set collumn5 = values(TRUE) where ano_publicacao < 1980;
/*3*/
update Livros set collumn1 = "Plume Books" where Livros = 1984;
/*4*/
...
/*8*/
select AVG(quantidade_paginas) where collumn5 = TRUE;
/*9*/
/*10*/